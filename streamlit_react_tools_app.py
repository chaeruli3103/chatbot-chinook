...
st.image("chinook_ER_Diagram.jpg", caption="Schema DB",  use_container_width=True)
...
with st.sidebar:
    ...
    # Google API key = AIzaSyDZqCZSIIk-QD5k76KoD5fzB-gYzytYQdM 
    
    #google_api_key = st.text_input("Google AI API Key",type="password")
    google_api_key = st.text_input(
    "Google AI API Key",
    type="password",
    value="AIzaSyDZqCZSIIk-QD5k76KoD5fzB-gYzytYQdM" 
    )    
    ...
    # Tambahan keterangan mengenai AI Agent
    st.subheader("🔎 Fitur Chatbot")
    st.markdown(
        """
        Chatbot ini dapat membantu Anda mendapatkan data berikut:
